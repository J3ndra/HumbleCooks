        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form
                    ...
                    <div class="mb-4">
                        <label for="ingredients" class="block text-base font-medium text-gray-700 dark:text-gray-300">Ingredients</label>
                    ...
                    <div class="mb-4">
                        <label for="tools" class="block text-base font-medium text-gray-700 dark:text-gray-300">Tools</label>
